...
class Seq2SeqDataCollator:
    ...
    def __call__(self, batch) -> Dict[str, torch.Tensor]:
        ...
        for lang in langs:
            ...
            batch_encoding = self.tokenizer([x["src_texts"][lang] for x in batch], max_length=data_args.max_source_length, padding=False, truncation=True)
            input_ids[lang] = batch_encoding["input_ids"]
            attention_mask[lang] = batch_encoding["attention_mask"]
        ...
        with self.tokenizer.as_target_tokenizer():
            for lang in target_langs:
                ...
                label = tokenizer([x["tgt_texts"][lang] for x in batch], max_length=data_args.max_target_length, padding=False, truncation=True)
                labels[lang] = label["input_ids"]
